...
- A 150-item decomposition stress diagnostic selected the lowest exact-provenance evidence items from three held-out Cohere cells and compared five parsing policies. Assertion-guarded query-aware multi-span retrieval recovered 83/150 auditable supports, compared with 24/150 for normalized full-note matching and 0/150 for exact full-note matching, while using far less context on supported items. It abstained on all 26 low-overlap possible-fabrication items and 18 assertion-conflict items in the stress set. A coherence audit found 0 high-risk supported items, with 29/83 supported items still carrying medium-risk review flags. This is failure-analysis evidence, not a population estimate or proof that chunking solves semantic fidelity.

...
A fixed Cohere seed did not make ambiguous model selection fully deterministic. Stability comes primarily from removing explicit-section evidence from generative selection.

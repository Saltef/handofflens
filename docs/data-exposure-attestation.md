...
The dataset was not reviewed by a human. All cases were run through Cohere for extraction. Subsequent review artifacts were produced by LLM judges, not clinicians or other human reviewers.
...
- All 2,000 cases were processed by the bulk Cohere extraction run.
...
The remaining 1,479 cases have bulk extraction exposure only. After excluding subjects and near-duplicate clusters overlapping the 521 development cases, 1,399 independent subject/cluster units remain eligible for a locked retrospective internal clinician validation.

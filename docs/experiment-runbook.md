...
Do not regenerate the historical clinician-oriented packet. It remains legacy development evidence and is not required for the source-fidelity endpoint.

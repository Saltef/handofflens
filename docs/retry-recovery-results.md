...
| Provider | Violating items before → after | Recovery rate [95%] | Mean paired Δ supported/case | Mean paired Δ items/case |
| --- | ---: | ---: | ---: | ---: |
...
item and supported-item counts (paired Δ ≈ 0). But recovery is **not** complete
...
| Live retry | mostly (Cohere ~79%, Haiku 100%) | yes | preserved (Δ ≈ 0) | one extra call per violating case; residual needs cap repair |

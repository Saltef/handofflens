...
| Case-gate arithmetic diagnostic | Are case failures driven partly by the number of extracted items? | Provenance reports now include item-count buckets, effective item-count estimates, conservative deduplication, and auditable-or-review-routed case metrics. | This exposes over-extraction and clean review-routing separately; it is not a replacement for factual labels. |

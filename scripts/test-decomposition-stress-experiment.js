...
assert.equal(aspirin.methods.query_aware_multispan.status, "query_multispan_supported");
...
assert.equal(report.summary.methods.find((item) => item.method === "query_aware_multispan").supported_tasks, 2);

console.log("PASS decomposition stress experiment (18 assertions)");

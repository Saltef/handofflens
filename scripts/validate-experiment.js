...
check("Public summary carries span-ID cap-repair diagnostics", /cap_repair/.test(JSON.stringify(publicResultsSummary.schema_ablation || {})) && /cap_repaired_item_support_rate/.test(JSON.stringify(publicResultsSummary.schema_ablation || {})) && /semantic entailment|target recall/i.test(JSON.stringify(publicResultsSummary.schema_ablation?.cap_repair || {})));
